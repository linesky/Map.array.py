...
def convert_rgb_to_16bit(red, green, blue):
    ...
    high_byte:int = ((red & 0b11110000) >> 4) | ((green & 0b11000000)>>2)
    low_byte:int = ((green & 0b00110000 )) | ((blue & 0b11110000)>>4)
    high_byte:str = chr(high_byte & 127)
...
def msgbox(msgs:str,color:str):
    ...
    for y in range(Height):
        for x in range(Width):
            ...
            ssd1,ssd2=convert_rgb_to_16bit(b,g,r)
            ssd=ssd+ssd1
            ssd=ssd+ssd2
